...
public class PLINKOC {
	...
	public static void PlinkoC() {
		...
		for (int i = 1; i <= 1000000; i++) {
			...
			if (peg1 + peg2 + peg3 + peg4 == 4) {
				peg5 = 0;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 == 5) {
				peg7 = 0;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 + peg7 + peg8 == 6) {
				peg9 = 0;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 + peg7 + peg8 + peg9 + peg10 == 7) {
				peg11 = 0;
			}
	...
	public static double percentage10000C() {
