...
public class PLINKOB {
	...
	public static void PlinkoB() {
		...
		for (int i = 1; i <= 1000000; i++) {
			...
			if (peg1 + peg2 + peg3 + peg4 == 3) {
				peg5 = 0;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 == 4) {
				peg7 = 0;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 + peg7 + peg8 == 5) {
				peg9 = 0;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 + peg7 + peg8 + peg9 + peg10 == 6) {
				peg11 = 0;
			}
	...
	public static double percentage10000B() {
