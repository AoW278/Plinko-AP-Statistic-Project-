...
public class PLINKOH {
	...
	public static void PlinkoH() {
		...
		for (int i = 1; i <= 1000000; i++) {
			...
			if (peg1 + peg2 + peg3 + peg4 == 1) {
				peg5 = 1;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 == 2) {
				peg7 = 1;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 + peg7 + peg8 == 3) {
				peg9 = 1;
			}
			if (peg1 + peg2 + peg3 + peg4 + peg5 + peg6 + peg7 + peg8 + peg9 + peg10 == 4) {
				peg11 = 1;
			}
	...
	public static double percentage10000H() {
